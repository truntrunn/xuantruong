...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/bapxantruong', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/bapxantruong/', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://tiktok.com/@ngoxuantruong29', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0978942135', '_blank');
    });
});
...
welcomeText.textContent = "Designed By Truntrundz =))";
